...
<script>
  ...
  import MainMenuLinks from "@/core/layout/components/mainMenu/components/MainMenuLinks";
  import MainMenuButtons from "@/core/layout/components/mainMenu/components/MainMenuButtons";
